...
(function () {
  ...
  // doen maar noodzaak: wat deze bewerker niet kent, schrijft hij anders weg. Tot 22 sep wiste één
  // keer opslaan zo het hele draaiboek van de tutorial, dat na T.GESPREKKEN stond.
  ...
  function renderFouten() {
    ...
    // Een vlag die hier gelezen maar nergens gezet wordt, komt meestal gewoon uit het spel zelf
    // (een quest, de heer). Dat is geen fout en hoort dus niet elke keer in beeld te staan.
