...
(function (T) {
  ...
  // Een vast toevalsgetal (0..1) uit drie gehele getallen, zodat dezelfde tegel met hetzelfde
  // zaad altijd dezelfde uitkomst geeft.
  function hasj(a, b, c) {
  ...
  // boogje van de muur springen en vallen. Losse pixels op hele pixels, geen gloed.
