...
(function (T) {
  ...
  //
  // Wie een gesprek voert, staat stil tot het uit is. En wie aan het maaien is (T.werkOogstBij,
  // js/akkers.js — roep die vóór T.laatDwalen aan) staat ook stil: hij heeft net zijn doel
  // bereikt en zwaait daar de zeis, dat is geen moment om weg te dwalen.
