...
// schapen", 25 sep 2026). Nog zonder regels: deze toetsen gaan over wat een dier ís en hoe het zich
// gedraagt als het stilstaat. Het zaad kiest zijn kleur (en dus zijn vel), zijn eigen ritme van
// grazen, staan en liggen komt uit de tijd en dat zaad (nooit uit Math.random per beeld), en een
// dier is neutraal: het vecht niet, praat niet, en dwaalt rond zijn plek.
